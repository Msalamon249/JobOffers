...
public class OfferHttpClient implements OfferFetchable {
    ...
    public List<JobOffersResponse> fetchOffers() {
        ...
        try {
            ...
            ResponseEntity<List<JobOffersResponse>> response = restTemplate.exchange(url, HttpMethod.GET, requestEntity,
                    new ParameterizedTypeReference<>() {
                    });
            final List<JobOffersResponse> body = response.getBody();
            if (body == null) {
